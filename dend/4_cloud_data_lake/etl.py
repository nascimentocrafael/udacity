...
def process_song_data(spark, input_data, output_data):
    '''
    Function to read 'song-data' from S3 or local directory, extract 'songs' and 'artists' tables and load them as parquet files in S3. Each table has its own directory on S3.
    Parameters:
        - spark: Spark session object.
